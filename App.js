...
import arbitration from './ArbitrationContract.sol';
import companyCon from './CompanyContract.sol';
import couponRegistry from './InsuranceCouponRegistry.sol'
import propertyReg from './PropertyRegistry.sol'
import clientCont from './ClientContract.sol'
...
onActionLogin = async (event) => {
event.preventDefault();
const accounts = await web3.eth.getAccounts();
const agreements =  clientCont.state._agreements;
